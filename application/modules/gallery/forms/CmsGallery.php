...
class Gallery_Form_CmsGallery extends Rastor_Form {
	...
	$gallery = $this->createElement('hidden', 'gallery', array('required' => false));
        ...
        $this->addDisplayGroup(array_merge($info, array('user_uri', 'preview', 'gallery', 'enable', 'protected')), 'info')
