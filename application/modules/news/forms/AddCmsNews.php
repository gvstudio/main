...
class News_Form_AddCmsNews extends Rastor_Form {
	...
	$mailer = $this->createElement('checkbox', 'mailer', array('required' => false, 'label' => 'Сделать рассылку новости'));
        $mailer->addDecorator('errors', array('class' => 'error msg'));
	$date = $this->createElement('text', 'date', array('label' => 'Дата'));
        ...
        $this->addDisplayGroup(array_merge($info, array('user_uri', 'preview', 'enable', 'mailer','protected','date')), 'info')
