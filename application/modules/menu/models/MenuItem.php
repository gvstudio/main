...
class Menu_Model_MenuItem extends Rastor_Model_Abstract {
    ...
    public function getJSONMenuList($id) {
        $records = $this->getDbTable()->getMenuItems($id);
    ...
    public function getNavigationArray($url, $language,$id) {
    	//Zend_Debug::dump($id);
        ...
        $items = $this->getDbTable()->getEnableRecords($id);
